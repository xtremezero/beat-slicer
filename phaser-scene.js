...
class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        window.addEventListener('startGame', () => {
            ...
            // Reset per-session achievement cache so per-run achievements are
            // re-evaluated cleanly on every new game.
            if (typeof SteamAchievements !== 'undefined') SteamAchievements.resetSession();
        });
    }
